...
export default async function ProjectsPage() {
    ...
    return (
        <div className="flex flex-row items-start justify-start gap-4 p-1 min-h-fit">
            <div className="flex flex-col space-y-4 p-4 bg-transparent rounded-lg shadow-md min-h-200">
